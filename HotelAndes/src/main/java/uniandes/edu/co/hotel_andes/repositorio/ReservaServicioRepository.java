...
/*         @Query("SELECT rs FROM ReservaServicio rs JOIN rs.habitaciones_id h JOIN h.usuarios_id u WHERE u.id = :usuarioId")
        Collection<ReservaServicio> darReservasServicioUsuario(@Param("usuarioId") long usuarioId); */
