...
public class Reserva {
    ...
    public ObjectId getHabitacion_id() {
        return habitacion_id;
    }

    public void setHabitacion_id(ObjectId habitacion_id) {
        this.habitacion_id = habitacion_id;
    }
